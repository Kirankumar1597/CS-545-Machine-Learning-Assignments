...
try:
    ...
    if rmse_min > 0.1 and rmse_max < 10:
        exec_grade += pts
        print(f'\n--- {pts}/{pts} points. Range of RMSE results are what is expected: 0.1 < RMSE < 10')
    else:
        print(f'\n--0  0/{pts} points.  Range of RMSE resuls should be between 0.1 and 10.  Yours are from {rmse_min} to {rmse_max}')
